      ...
      >
        ...
        <div className="bg-neutral-900/40 backdrop-blur-3xl border border-white/10 p-10 rounded-[3.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.6)] text-center relative overflow-hidden group">
          ...
          >
            <motion.button
              ...
              onClick={onLogin}
              className={cn(
                "w-full py-5 bg-white text-black rounded-3xl font-black uppercase tracking-widest text-xs transition-all flex items-center justify-center gap-4 shadow-[0_15px_30px_rgba(0,0,0,0.4)] group relative overflow-hidden",
        ...
        >
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <p className="text-[9px] text-brand font-bold uppercase tracking-[0.2em]">All Modules Operational</p>
          </div>
        </motion.div>
      </motion.div>
