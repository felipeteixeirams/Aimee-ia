...
| **Fase 5: Regras de Domínio** | `src/domain/` | `[[domains/core_business_logic.md]]` | 🏗️ **Focando a Seguir** | 15% |
| **Fase 6: Camada de Infra** | `src/infrastructure/` | `[[integrations/database_and_repositories.md]]` | ⏳ Pendente | 15% |
| **Fase 7: Entrada Backend** | `src/server/` & `server.ts` | `[[architecture/backend_express_orchestration.md]]` | ⏳ Pendente | 10% |
| **Fase 8: Interface e UX** | `src/client/` | `[[architecture/client_react_spa.md]]` | ⏳ Pendente | 10% |

> **🔥 Cobertura Geral Estimada**: **50%** (AGENTS.md + Fase 1 + Fase 2 + Fase 3 + Fase 4 descritos estruturalmente).
